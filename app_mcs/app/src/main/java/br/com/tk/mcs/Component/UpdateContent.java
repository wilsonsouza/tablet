...
{
   public static final String TAG = UpdateContent.class.getName();
    ...
    */
   public static final void Refresh(ViewGroup subTreeRoot)
   {
      Refresh(subTreeRoot, false, MeasureSpec.UNSPECIFIED, MeasureSpec.UNSPECIFIED);
   }

   /**
    * Same but allows re-layout of all views, not only those with "wrap_content". Necessary for "center", "right", "bottom",...
    */
   public static final void Refresh(ViewGroup subTreeRoot, boolean relayoutAllNodes)
   {
      Refresh(subTreeRoot, relayoutAllNodes, MeasureSpec.UNSPECIFIED, MeasureSpec.UNSPECIFIED);
   }

   /**
    * Same as previous, but with given size in case subTreeRoot itself has layout_width or layout_height = "wrap_content"
    */
   public static void Refresh(ViewGroup subTreeRoot, boolean relayoutAllNodes, int subTreeRootWidthMeasureSpec, int subTreeRootHeightMeasureSpec)
   {
      //Log.d(TAG, "+++ LayoutWrapContentUpdater wrapContentAgain on subTreeRoot=[" + subTreeRoot + "], with w=" + subTreeRootWidthMeasureSpec + " and h=" + subTreeRootHeightMeasureSpec);
